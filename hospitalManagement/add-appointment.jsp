...
$(document).ready(function() {
    ...
    $("#department_id").change(function(){
        ...
        $.ajax({
            ...
            {
                if (data.status == true) {
                    doctor_list.jsp(data.message);
                    available_day.jsp(data.available_days);
                    output.jsp('');
                } else if (data.status == false) {
                    doctor_list.jsp('');
                    output.jsp(data.message).addClass('text-danger').removeClass('text-success');
                } else {
                    doctor_list.jsp('');
                    output.jsp(data.message).addClass('text-danger').removeClass('text-success');
                }
    ...
    $("#doctor_id").change(function(){
        ...
        $.ajax({
            ...
            {
                if (data.status == true) {
                    output.jsp(data.message).addClass('text-success').removeClass('text-danger');
                } else if (data.status == false) {
                    output.jsp(data.message).addClass('text-danger').removeClass('text-success');
                } else {
                    output.jsp(data.message).addClass('text-danger').removeClass('text-success');
        ...
        $.ajax({
            ...
            { 
                if (data.status == true) {
                    ...
                    serial_preview.jsp(data.message);
                } else if (data.status == false) {
                    schedule_id.val('');
                    serial_preview.jsp(data.message).addClass('text-danger').removeClass('text-success');
                } else {
                    schedule_id.val('');
                    serial_preview.jsp(data.message).addClass('text-danger').removeClass('text-success');
                }
